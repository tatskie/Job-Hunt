  ...
  <body data-spy="scroll" data-target="#probootstrap-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark probootstrap_navbar" id="probootstrap-navbar">
      <div class="container">
        ...
        <a class="navbar-brand" href="/"><img src="{{url('user/ugmad.png')}}" height="50px" width="50px"></a>
        ...
        <div class="row align-items-center">
          <div class="col-md">
            ...
            <p class="lead mb-5 probootstrap-animate">
              ...
              <a href="{{url('register')}}" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Post a Job</a> 
            </p>
          </div> 
          <div class="col-md probootstrap-animate">
            {!! Form::open(array('route' => 'search', 'class'=>'probootstrap-form')) !!}
              <div class="form-group">
                <div class="row mb-3">
                  <div class="col-md">
                    <div class="form-group">
                      <label for="id_label_single">Select City</label>

                      <label for="id_label_single" style="width: 100%;">
                        <select class="js-example-basic-single js-states form-control" id="id_label_single" style="width: 100%;">
                          <option value="Australia">Metro Manila</option>
                          <option value="Japan">Cebu</option>
                          <option value="United States">Mindanao</option>
                          <option value="Brazil">Gensan</option>
                          <option value="China">Cagayan De Oro</option>
                          <option value="Israel">Pagadian</option>
                          <option value="Philippines">Bohol</option>
                        </select>
                      </label>
                ...
                <div class="row mb-5">
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <label for="probootstrap-date-departure">Search Jobs</label>
                      <div class="probootstrap-date-wrap">
                        <span class="icon ion-calendar"></span> 
                        {!! Form::text('search', null,
                            array('required',
                            'class'=>'form-control',
                            'placeholder'=>'Search job...','id'=>'searchItem')) !!}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md">
                    {!! Form::submit('Find a Job',array('class'=>'btn btn-primary btn-block')) !!}

                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                    ...
                    <div class="widget-wrapper">
                        ...
                        <div class="list-group">
                        	<a class="list-group-item">{{ucfirst(Auth::user()->last_name)}}, {{ucfirst(Auth::user()->first_name)}} {{ucfirst(Auth::user()->middle_initial)}}.</a>
                            <a class="list-group-item">{{ucfirst(Auth::user()->address)}}, {{ucfirst(Auth::user()->city)}}, {{ucfirst(Auth::user()->country)}}</a>
                            <a class="list-group-item">{{ucfirst(Auth::user()->age)}} yrs. old</a>
                            <a class="list-group-item">{{Auth::user()->email}}</a>
                            <a class="list-group-item">{{Auth::user()->contact}}</a>
		                                ...
		                                <div class="card-body">
		                                    ...
		                                    <h5 class="font-bold">
                                                ...
                                                <br>
                                                    ...
                                                    @if($skill->userSumRating == 1)
                                                    Basic
                                                    @elseif($skill->userSumRating == 2)
                                                    Basic
                                                    @elseif($skill->userSumRating == 3)
                                                    Meduim
                                                    @else
                                                    Excelent
                                                    @endif
                                                    @for ($i =1; $i <= $skill->userSumRating; $i++)
